...
const PAGE_COPY = {
  en: {
    ...
    book: {
      ...
      formNote:'Corrections and new show suggestions are reviewed by the Paris Comedy team, then added to the verified public directory once confirmed.',
  ...
  de: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ Schnellstart-Brief', heading:'Keine Lust, bei null anzufangen? Wählen Sie den passendsten Brief.', desc:'Die schnellsten Conversion-Chancen liegen weiter bei Private-/Corporate-Events und offenem Sunday-Inventar. Diese Buttons füllen das Formular vor, damit Käufer mit einem Klick ein brauchbares Briefing senden können.', response:'Ideal für Angebotsanfragen noch am selben Tag', sunday:'🌞 Privates Sunday-Event', corporate:'🏢 Corporate- / Team-Event', listing:'📋 Venue oder neue Show eintragen' },
