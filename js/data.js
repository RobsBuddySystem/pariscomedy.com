...
const OTHER_SHOWS_RAW = [
    ...
    { id:'friday-night-show', name:'Friday Night Show', venue:'pomme-eve', venueName:'La Pomme d\'Eve', address:'1 Rue des Boulangers, 75005 Paris', day:'Friday', time:'20:00', type:'standup', emoji:'🍎',
      description:'Friday English stand-up at La Pomme d’Eve with a live recurring Eventbrite listing in the Latin Quarter.',
      descFr:'Stand-up en anglais le vendredi à La Pomme d’Eve, avec une vraie récurrence Eventbrite dans le Quartier Latin.',
      paid:false,
      runner:'Friday Night Show', verificationSource:'Eventbrite search results', verifiedAt:'2026-04-07', showUrl:'https://www.eventbrite.com/d/france--paris/english-comedy/?page=1' },
...
const TRANSLATIONS = {
    en: {
        ...
        stats: { shows:'30', showsLabel:'Weekly Shows', venues:'23', venuesLabel:'Venues', bilingual:'FR+EN', bilingualLabel:'Bilingual', est:'~2010', estLabel:'Est.' },
    ...
    fr: {
        ...
        stats: { shows:'30', showsLabel:'Spectacles/sem', venues:'23', venuesLabel:'Salles', bilingual:'FR+EN', bilingualLabel:'Bilingue', est:'~2010', estLabel:'Depuis' },
        ...
        history: { title:'L\'Histoire de la Comédie Anglaise à Paris', intro:'D\'un New-Yorkais avec un rêve à 30 spectacles hebdomadaires vérifiés — comment Paris est devenue l\'une des grandes capitales européennes de la comédie en anglais.', keyPlayers:'Les Acteurs Clés', notableVisitors:'Visiteurs Notables', visitorsIntro:'Humoristes internationaux qui se sont produits sur les scènes parisiennes :', stages:'Étapes de la scène' }
    },
    es: {
        ...
        stats: { shows:'30', showsLabel:'Shows/sem', venues:'23', venuesLabel:'Locales', bilingual:'FR+EN', bilingualLabel:'Bilingüe', est:'~2010', estLabel:'Desde' },
    ...
    de: {
        ...
        stats: { shows:'30', showsLabel:'Wöchentliche Shows', venues:'23', venuesLabel:'Venues', bilingual:'FR+EN', bilingualLabel:'Zweisprachig', est:'~2010', estLabel:'Seit' },
    ...
    ja: {
        ...
        stats: { shows:'30', showsLabel:'毎週のショー', venues:'23', venuesLabel:'会場', bilingual:'FR+EN', bilingualLabel:'バイリンガル', est:'~2010', estLabel:'創設' },
        ...
        history: { title:'パリにおける英語コメディの歴史', intro:'夢を持つ一人のニューヨーカーから週30本の検証済みショーへ — パリがヨーロッパ最大級の英語コメディ都市の一つになるまで。', keyPlayers:'主要人物', notableVisitors:'著名な訪問者', visitorsIntro:'パリのステージで公演した国際的なコメディアン：', stages:'成長の段階' }
    },
    zh: {
        ...
        stats: { shows:'30', showsLabel:'每周演出', venues:'23', venuesLabel:'场地', bilingual:'FR+EN', bilingualLabel:'双语', est:'~2010', estLabel:'创立' },
