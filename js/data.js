...
const OTHER_SHOWS = [
    ...
    { name:'The Dissident Comedy Show', venueName:'The Dissident Club', day:'Wednesday', time:'20:30', type:'standup', emoji:'🎭', description:'English stand-up at The Dissident Club. Wednesday night mainstay with a sharp, alternative comedy vibe.', paid:false },
    { name:'English Stand-Up Thu & Sat', venueName:'76 Rue Jean-Pierre Timbaud', day:'Thursday', time:'18:30', type:'standup', emoji:'🎤', description:'English stand-up comedy nights on Thursdays and Saturdays at a Parisian venue known for lively crowds.', paid:false },
    { name:'Blast Off All Stars', venueName:'La Pomme d\'Eve', day:'Saturday', time:'19:30', type:'standup', emoji:'🚀', description:'English stand-up showcase at La Pomme d\'Eve. All-star lineup, Saturday night energy.', paid:false },
    ...
    { name:'South Comedy Club', venueName:'Comédie Café', day:'Wednesday', time:'20:00', type:'standup', emoji:'☀️', description:'South Comedy Club at Comédie Café — Wednesday nights and 40+ upcoming dates. One of the most active English comedy clubs in Paris.', paid:false },
    ...
    { name:'Oscar Comedy Club', venueName:'Café Oscar', day:'Sunday', time:'17:00', type:'standup', emoji:'🏆', description:'Oscar Comedy Club at Café Oscar — Sunday afternoons and 80+ upcoming dates. English and French comedy, one of the most frequent shows in Paris.', paid:false }
];
