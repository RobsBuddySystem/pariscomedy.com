...
const TRANSLATIONS = {
    ...
    fr: {
        ...
        footer: { copyright:'© 2026 Paris Comedy · Made with 🍟 in Paris', tagline:'Le Foyer de la Comédie en Anglais à Paris. Depuis ~2010.', contact:'Contact', legal:'Mentions Légales', privacy:'Confidentialité', terms:'CGU', pages:'Pages', comedians:'Pour les humoristes', contactForm:'Formulaire de contact' },
...
const PAGE_COPY = {
  ...
  fr: {
    header: { subtitle:'Montez sur scène, engagez un humoriste ou référencez votre spectacle sur pariscomedy.com' },
