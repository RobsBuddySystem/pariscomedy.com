...
const TIMELINE = [
    ...
    { year:'2024–2025', title:'The Explosion', text:'The scene explodes. Multiple weekly English shows across Paris. What started as one guy from New York at SoGymnase grows into a citywide discovery engine for tourists, expats, and locals — and sets up the verified 29-show, 23-venue scene Paris has today.' },
    { year:'2026', title:'The Golden Age', text:'29 verified weekly English-language shows across 23 current venues. Wednesday nights at Velvet Bar anchor the scene with a three-show stack: open mic, showcase, and the flagship bilingual French Fried Comedy Night. From one guy with a mic at Paname in 2013 to a full discovery engine with paid listings, bilingual headliners, and tourists actively booking comedy in Paris — the scene has become one of Europe\'s strongest English-language live-comedy hubs.' }
];
...
const PAGE_COPY = {
  en: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ Fast brief starter', heading:'Don’t want to write from scratch? Pick the closest brief.', desc:'Mitzi’s latest booking report says the fastest money is still private/corporate entertainment and open Sunday inventory. These buttons pre-fill the form so buyers can send a usable brief in one tap.', response:'Best for same-day quote requests', sunday:'🌞 Sunday private event', corporate:'🏢 Corporate / team event', listing:'📋 List a room or new show' },
  ...
  fr: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ Brief rapide', heading:'Pas envie d’écrire depuis zéro ? Choisissez le brief le plus proche.', desc:'Le dernier rapport de Mitzi dit clairement que l’argent le plus rapide reste le corporate/privé et l’inventaire du dimanche encore ouvert. Ces boutons préremplissent le formulaire pour envoyer un brief exploitable en un clic.', response:'Idéal pour les demandes de devis dans la journée', sunday:'🌞 Événement privé du dimanche', corporate:'🏢 Événement corporate / équipe', listing:'📋 Référencer une salle ou un nouveau spectacle' },
  ...
  es: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ Inicio rápido', heading:'¿No quieres escribir desde cero? Elige el brief más cercano.', desc:'El último informe de Mitzi deja claro que el dinero más rápido sigue estando en eventos privados/corporativos y en el inventario abierto del domingo. Estos botones rellenan el formulario para enviar un brief útil en un toque.', response:'Ideal para pedir presupuesto el mismo día', sunday:'🌞 Evento privado en domingo', corporate:'🏢 Evento corporativo / de equipo', listing:'📋 Añadir sala o show nuevo' },
  ...
  de: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ Schnellstart-Brief', heading:'Keine Lust, bei null anzufangen? Wählen Sie den passendsten Brief.', desc:'Mitzi’s letzter Booking-Report zeigt klar: Das schnellste Geld liegt weiter bei Private-/Corporate-Events und offenem Sunday-Inventar. Diese Buttons füllen das Formular vor, damit Käufer mit einem Klick ein brauchbares Briefing senden können.', response:'Ideal für Angebotsanfragen noch am selben Tag', sunday:'🌞 Privates Sunday-Event', corporate:'🏢 Corporate- / Team-Event', listing:'📋 Venue oder neue Show eintragen' },
  ...
  ja: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ クイック依頼', heading:'最初から書きたくないですか？いちばん近い依頼を選んでください。', desc:'Mitzi の最新ブッキング報告では、最も早く収益化しやすいのは企業・プライベート案件と、まだ空きのある日曜枠だと示されています。これらのボタンでフォームを事前入力し、1タップで実用的な依頼を送れます。', response:'当日見積もり依頼に最適', sunday:'🌞 日曜のプライベートイベント', corporate:'🏢 企業 / チームイベント', listing:'📋 会場または新規ショーを掲載' },
  ...
  zh: {
    ...
    book: {
      ...
      quickBrief:{ badge:'⚡ 快速需求模板', heading:'不想从零开始写？选择最接近的需求模板。', desc:'Mitzi 最新的预订报告显示，最快的收入机会仍然是企业/私人活动，以及仍有空档的周日场次。这些按钮会预填表单，让买家一键发送可执行的需求。', response:'适合同日询价', sunday:'🌞 周日私人活动', corporate:'🏢 企业 / 团队活动', listing:'📋 收录场地或新演出' },
