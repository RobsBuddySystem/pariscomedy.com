...
const VENUES = [
    { id:'velvet', name:'Velvet Bar', address:'43 Rue Saint-Honoré, 75001 Paris', neighborhood:'Les Halles (1er)', lat:48.8607768, lng:2.3454208, mapX:50, mapY:42, listed:true, description:'A cocktail bar in the 1er, Les Halles, 160m from Châtelet. Hosts the French Fried Comedy Night Wednesday stack — three back-to-back English-language shows on the same stage. Free entry, drink purchase mandatory.', metro:'Châtelet (M1/M4/M7/M11/M14)', website:'https://velvet-bar.fr/', source:'velvet-bar.fr/contact + Eventbrite event 1977106148713 — verified 2026-05-18' },
    { id:'paname', name:'Paname Art Café', address:'14 Rue de la Fontaine au Roi, 75011 Paris', neighborhood:'11th arrondissement', lat:48.8644, lng:2.3689, mapX:68, mapY:38, listed:false, description:'A legendary venue in the 11th where French Fried Comedy Night was born in 2013. Kept here as a historical comedy landmark, not as a current featured English listing on this site.', metro:'République (M3/M5/M8/M9/M11) · Goncourt (M11)' },
    ...
    { id:'comedie-cafe', name:'Comédie Café', address:'Paris', neighborhood:'Paris', lat:48.8660, lng:2.3520, mapX:54, mapY:38, listed:false, description:'Comedy venue in Paris. No current English-language ParisComedy listing.', metro:'' },
    ...
    { id:'cafe-oscar', name:'Café Oscar', address:'155 Rue Montmartre, 75002 Paris', neighborhood:'Montorgueil / Bourse (2nd)', lat:48.8700, lng:2.3400, mapX:44, mapY:30, listed:false, description:'Comedy venue in Paris. No current English-language ParisComedy listing.', metro:'Grands Boulevards (M8/M9)' },
    ...
    { id:'cuba-compagnie', name:'Cuba Compagnie', address:'48 Bd Beaumarchais, 75011 Paris', neighborhood:'Bastille (11th)', lat:48.8566, lng:2.3668, mapX:67, mapY:52, listed:false, description:'Bastille venue. No current English-language ParisComedy listing.', metro:'Chemin Vert (M8)' },
    ...
    { id:'cafe-plage', name:'Le Café de la Plage', address:'Paris', neighborhood:'Charonne (11th)', lat:48.8530, lng:2.3820, mapX:78, mapY:54, listed:false, description:'East Paris venue. No current English-language ParisComedy listing.', metro:'Charonne (M9)' },
    ...
    { id:'cotte23', name:'Cotte 23', address:'23 Rue de la Mare, 75020 Paris', neighborhood:'Belleville (20th)', lat:48.8693, lng:2.3817, mapX:72, mapY:35, listed:false, description:'Belleville venue. No current English-language ParisComedy listing.', metro:'Ménilmontant (M2)' },
...
const SHOWS = [
    { id:'ffcn', name:'French Fried Comedy Night', shortName:'FFCN', venue:'velvet', type:'standup', day:'Wednesday', time:'22:00', price:'Free', emoji:'🍟',
      description:'THE English-language comedy show. International comics, Paris energy, same Wednesday-night stage.',
                  bookingUrl:'https://www.eventbrite.com/e/french-fried-comedy-night-tickets-1989838522586' + UTM, featured:true },
...
const OTHER_SHOWS_RAW = [
    ...
    { id:'kiss-comedy', name:'Kiss Comedy Club', venue:'coquin', venueName:'Le Coquin', address:'Paris', day:'Wednesday', time:'20:00', type:'standup', emoji:'💋',
      description:'Midweek English-language comedy in an intimate Paris bar.',
      descFr:'Comédie anglaise et English-language en milieu de semaine dans un bar parisien intimiste.',
    ...
    { id:'broadway-comedy-club', name:'Broadway Comedy Club - Paris', venue:'bonne-nouvelle', venueName:'25 Bd de Bonne Nouvelle', address:'25 Bd de Bonne Nouvelle, 75002 Paris', day:'daily', time:'19:00', type:'standup', emoji:'🎬', paid:true,
      description:'Daily English-language stand-up near Bonne Nouvelle with a high-volume schedule and one of the deepest recurring calendars in central Paris.',
      descFr:'Stand-up en anglais et English-language tous les soirs près de Bonne Nouvelle, avec un calendrier très dense au cœur de Paris.',
...
const KEY_PLAYERS = [
    ...
    { id:'paul', name:'Paul Taylor', title:'The Breakout', emoji:'🇬🇧',
      ...
      bio:'British comedian who moved to Paris in 2009 and got his start performing at French Fried Comedy Night, hosted by Robert le Ricain. His 2016 "La Bise" video — produced and directed by Robert — went viral with 3M+ views, leading Canal+ to give him "What The Fuck France," the first English-language show on French TV. His #Franglais, "So British", and "Bisoubye x" tours sold out across France. 1.5M+ followers across platforms.',
    ...
    { id:'robert', name:'Robert le Ricain', title:'Early Builder', emoji:'🍟',
      instagram:'https://www.instagram.com/Robertlericain/',
      bio:'American English-language comedian and one of the early builders of the Paris English-language comedy scene. He launched French Fried Comedy Night in 2013 at Paname Art Café, helped give Paul Taylor one of his first regular stages, and produced and directed "La Bise" — the viral video that helped map the scene for a wider audience. He belongs in the timeline and listings as a key historical reference point.',
      bioFr:'Humoriste américain English-language qui a fondé French Fried Comedy Night en 2013 au Paname Art Café — le plus ancien spectacle de stand-up en anglais encore en activité à Paris. Il a donné à Paul Taylor sa première scène régulière et a produit et réalisé \"La Bise\". Maintenant au Velvet Bar (43 Rue Saint-Honoré, 1er) chaque mercredi.',
      bioEs:'Comediante estadounidense English-language y uno de los primeros constructores de la escena anglófona en París. Lanzó French Fried Comedy Night en 2013 en Paname Art Café, dio a Paul Taylor uno de sus primeros escenarios regulares y produjo/dirigió "La Bise". Aparece aquí como referencia histórica importante.' },
    { id:'tamer', name:'Tamer Kattan', title:'NY to Paris', emoji:'🌍',
      instagram:'https://www.instagram.com/tamerkat/',
      bio:'New York comedian who made Paris his second home. 159K+ followers on social media. Regular collaborator with Robert le Ricain and a favorite on the Paris English-language comedy circuit.',
    ...
    { id:'tania', name:'Tania Dutel', title:'Rising Star', emoji:'✨',
      ...
      bio:'French comedian who performs brilliantly in both French and English. Known for her sharp observational humor and fearless stage presence. A regular at English-language shows in Paris and proof that French comics can work the English-language scene.',
...
const TIMELINE = [
    ...
    { year:'2013', title:'French Fried is Born', text:'French Fried Comedy Night launches at Paname Art Café — the English-language comedy show that would become the longest-running English stand-up night in Paris. A young Paul Taylor is among the early comics to perform there. The scene now has a weekly home.' },
    ...
    { year:'2026', title:'The Golden Age', text:'{showCount} verified weekly English-language shows across {venueCount} current venues. Wednesday nights at Velvet Bar anchor the scene with a three-show stack: open mic, showcase, and the flagship English-language French Fried Comedy Night. From one guy with a mic at Paname in 2013 to a full discovery engine with paid listings, international headliners, and tourists actively booking comedy in Paris — the scene has become one of Europe\'s strongest English-language live-comedy hubs.' }
];

/* Untranslatable words — English-language comedy content, rotates on each visit */
...
const COMEDY_QUOTES = [
    { text:'"The French think Americans are funny. Americans think the French are funny. I\'m here to prove them both right."', author:'Robert le Ricain' },
    ...
    { text:'"Best pancake of my life… still only second best day in France. First was learning my name means boobies."', author:'Robert le Ricain' },
    { text:'"People ask me if I\'m more American or more French now. The answer depends on whether the waiter just brought me the wrong order."', author:'Robert le Ricain' },
    { text:'"My brain now thinks in both French and English at the same time. The result is a kind of anxious fog with a baguette — just a kind of anxious fog with a baguette in it."', author:'Robert le Ricain' },
...
const TESTIMONIALS = [
    ...
    { text:'I didn\'t know I needed English-language comedy in my life until FFCN. Now I\'m addicted.', author:'Thomas K.', source:'Eventbrite', stars:5 },
...
/* English-only overhaul: no French-show public fallback. */
const FRENCH_SHOWS = [];
...
const TRANSLATIONS = {
    en: {
        ...
        hero: { info:'🎟️ Reserve your spot · 🍺 One drink minimum · 🎩 Pass the hat for the performers', tag:'🇫🇷 English-language comedy every week in Paris', title:'Paris <span class="gradient-text">Comedy</span>', subtitle:'The Home of English-Language Comedy in Paris', desc:'Live stand-up in French & English. Open mics, showcases, and the legendary French Fried Comedy Night. Every week across Paris.', cta:'🎟️ Reserve Your Spot', browse:'Browse Shows' },
        stats: { shows:'{showCount}', showsLabel:'Weekly Shows', venues:'{venueCount}', venuesLabel:'Venues', English-language:'FR+EN', English-languageLabel:'English-language', est:'~2010', estLabel:'Est.' },
        ...
        book: { perform:'Want to Perform?', performDesc:'Got 5 minutes of material and zero fear? Email us to get on a show. We run open mics every Wednesday — all levels welcome.', corporate:'Book a Comedian', corporateDesc:'Corporate events, private parties, festivals, team-building — we\'ll match you with the perfect comic. English-language performers available.', list:'List Your Show', listDesc:'Running an English comedy night in Paris? Get featured on pariscomedy.com for €1/month.', contact:'Get in Touch', name:'Your Name', email:'Email', message:'Message', send:'Send Message' },
    ...
    fr: {
        ...
        hero: { info:'🎟️ Réservez votre place · 🍺 Une consommation minimum · 🎩 Le chapeau pour les artistes', tag:'🇫🇷 Stand-up English-language chaque semaine à Paris', title:'Paris <span class="gradient-text">Comedy</span>', subtitle:'Le guide du stand-up anglophone à Paris', desc:'Stand-up en français et en anglais. Open mics, plateaux et la légendaire French Fried Comedy Night. Chaque semaine à Paris.', cta:'🎟️ Réserver votre place', browse:'Voir les spectacles' },
        stats: { shows:'{showCount}', showsLabel:'Spectacles/sem', venues:'{venueCount}', venuesLabel:'Salles', English-language:'FR+EN', English-languageLabel:'English-language', est:'~2010', estLabel:'Depuis' },
        ...
        book: { perform:'Vous Voulez Monter sur Scène ?', performDesc:'Vous avez 5 minutes de matériel et zéro peur ? Écrivez-nous pour être programmé. Nous organisons des scènes ouvertes chaque mercredi — tous niveaux bienvenus.', corporate:'Engager un Humoriste', corporateDesc:'Événements d\'entreprise, soirées privées, festivals, team-building — on vous trouve le comique parfait. Artistes English-languages disponibles.', list:'Référencer Votre Spectacle', listDesc:'Vous organisez un spectacle de comédie en anglais à Paris ? Apparaissez sur pariscomedy.com pour 1€/mois.', contact:'Contactez-nous', name:'Votre Nom', email:'Email', message:'Message', send:'Envoyer' },
    ...
    es: {
        ...
        hero: { info:'🎟️ Reserva tu lugar · 🍺 Una consumición mínima · 🎩 El sombrero para los artistas', tag:'🇫🇷 Comedia English-language cada semana en París', title:'Paris <span class="gradient-text">Comedy</span>', subtitle:'El Hogar de la Comedia en Inglés en París', desc:'Stand-up en francés e inglés. Micros abiertos, showcases y la legendaria French Fried Comedy Night. Cada semana en París.', cta:'🎟️ Reserva Tu Lugar', browse:'Ver Shows' },

        stats: { shows:'{showCount}', showsLabel:'Shows/sem', venues:'{venueCount}', venuesLabel:'Locales', English-language:'FR+EN', English-languageLabel:'English-language', est:'~2010', estLabel:'Desde' },
        ...
        book: { perform:'¿Quieres Actuar?', performDesc:'¿Tienes 5 minutos de material y cero miedo? Escríbenos para subir al escenario. Organizamos open mics cada miércoles — todos los niveles son bienvenidos.', corporate:'Contrata un Comediante', corporateDesc:'Eventos corporativos, fiestas privadas, festivales, team-building — te encontramos al cómico perfecto. Artistas English-languages disponibles.', list:'Lista Tu Show', listDesc:'¿Organizas una noche de comedia en inglés en París? Aparece en pariscomedy.com por 1€/mes.', contact:'Contáctanos', name:'Tu Nombre', email:'Email', message:'Mensaje', send:'Enviar' },
    ...
    de: {
        ...
        stats: { shows:'{showCount}', showsLabel:'Wöchentliche Shows', venues:'{venueCount}', venuesLabel:'Venues', English-language:'FR+EN', English-languageLabel:'Zweisprachig', est:'~2010', estLabel:'Seit' },
    ...
    ja: {
        ...
        stats: { shows:'{showCount}', showsLabel:'毎週のショー', venues:'{venueCount}', venuesLabel:'会場', English-language:'FR+EN', English-languageLabel:'バイリンガル', est:'~2010', estLabel:'創設' },
    ...
    zh: {
        ...
        stats: { shows:'{showCount}', showsLabel:'每周演出', venues:'{venueCount}', venuesLabel:'场地', English-language:'FR+EN', English-languageLabel:'双语', est:'~2010', estLabel:'创立' },
    ...
    ko: {
        ...
        stats: { shows:'{showCount}', showsLabel:'주간 쇼', venues:'{venueCount}', venuesLabel:'공연장', English-language:'FR+EN', English-languageLabel:'이중언어', est:'~2010', estLabel:'시작' },
