...
const OTHER_SHOWS = [
    ...
    { name:'Green Mic Showcase', venueName:'Au Soleil de la Butte', day:'Friday', time:'20:15', type:'standup', emoji:'🎙️', featured:true,
      ...
      paid:false },
    { name:'Comedy Crush Wednesday Show', venueName:'Les Cariatiades', day:'Wednesday', time:'20:30', type:'standup', emoji:'💥',
      description:'English stand-up comedy every Wednesday at Les Cariatiades. Consistently packed room with a great crowd energy.',
      descFr:'Stand-up en anglais chaque mercredi aux Cariatiades. Salle régulièrement comble, ambiance électrique.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/comedy-crushs-wednesday-show-tickets-1982356098454' },
    { name:'The Dissident Comedy Show', venueName:'The Dissident Club', day:'Wednesday', time:'20:30', type:'standup', emoji:'🎭',
      description:'English stand-up at The Dissident Club. Wednesday night mainstay with a sharp, alternative comedy vibe.',
      descFr:'Stand-up en anglais au Dissident Club. Rendez-vous incontournable du mercredi soir, comédie franche et alternative.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/the-dissident-comedy-show-tickets-1985334998424' },
    { name:'English Stand-Up Thu & Sat', venueName:'76 Rue Jean-Pierre Timbaud', day:['Thursday','Saturday'], time:'18:30', type:'standup', emoji:'🎤',
      description:'English stand-up comedy nights on Thursdays and Saturdays at a Parisian venue known for lively crowds.',
      descFr:'Soirées de stand-up en anglais les jeudis et samedis dans un bar parisien réputé pour son ambiance.',
      paid:false, bookingUrl:'https://www.eventbrite.com/e/english-stand-up-comedy-in-paris-thursday-saturday-night-shows-tickets-1978714059016' },
    { name:'Blast Off All Stars', venueName:'La Pomme d\'Eve', day:'Saturday', time:'19:30', type:'standup', emoji:'🚀',
      description:'English stand-up showcase at La Pomme d\'Eve. All-star lineup, Saturday night energy.',
      descFr:'Showcase de stand-up en anglais à La Pomme d\'Eve. Plateau all-stars, énergie du samedi soir.',
      paid:false, bookingUrl:'https://www.eventbrite.com/e/blast-off-all-stars-english-stand-up-comedy-april-25-tickets-1986150988071' },
    { name:'MANGO English Stand-Up', venueName:'Le Paris de l\'Humour', day:'Wednesday', time:'19:45', type:'standup', emoji:'🥭',
      description:'English stand-up comedy at Le Paris de l\'Humour — Wednesday nights with Randy J Dreams.',
      descFr:'Stand-up en anglais au Paris de l\'Humour — les mercredis avec Randy J Dreams.',
      paid:false, bookingUrl:'https://www.eventbrite.ca/e/mango-english-stand-up-comedy-in-paris-randy-j-dreams-tickets-1984868292494' },
    { name:'Friday Night Show', venueName:'La Pomme d\'Eve', day:'Friday', time:'20:00', type:'standup', emoji:'🍎',
      description:'English stand-up comedy every Friday night at La Pomme d\'Eve. Regular showcase with rotating lineups.',
      descFr:'Stand-up en anglais chaque vendredi soir à La Pomme d\'Eve. Showcase régulier avec des plateaux renouvelés.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/english-stand-up-comedy-in-paris-friday-night-show-tickets-1978820961765' }
    { name:'Millennial Meltdown', venueName:'Le Bikini Bottom', day:'Wednesday', time:'20:00', type:'standup', emoji:'🔥',
      description:'English comedy show — stand-up night in Paris. Weekly at Le Bikini Bottom.',
      descFr:'Soirée comédie en anglais — stand-up hebdomadaire au Bikini Bottom.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/billets-english-comedy-show-millennial-meltdown-paris-stand-up-night-1984665294321' },
    { name:'Green Light Comedy', venueName:'Les Marquises', day:'Tuesday', time:'20:15', type:'standup', emoji:'🟢',
      description:'English stand-up every Tuesday at 20:15 at Les Marquises — one of the most consistent comedy nights on the Paris circuit. Great for locals and first-timers.',
      descFr:'Stand-up en anglais chaque mardi à 20h15 aux Marquises — l\'une des soirées comiques les plus régulières de Paris. Parfait pour les habitués et les novices.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/standup-comedy-in-english-green-light-in-paris-tickets-927454971787' },
    { name:'The Englishman Comedy Night', venueName:'The Englishman Cocktail Club', day:'Thursday', time:'20:00', type:'standup', emoji:'🇬🇧',
      description:'English comedy night at The Englishman Cocktail Club in Paris.',
      descFr:'Soirée comédie en anglais à l\'Englishman Cocktail Club à Paris.',
      paid:false, bookingUrl:'https://www.eventbrite.com/e/the-englishman-comedy-night-tickets-1982274965784' },
    { name:'Funny Women Paris', venueName:'Le Noddi', day:'Tuesday', time:'20:00', type:'standup', emoji:'👩‍🎤',
      description:'English stand-up comedy in Paris featuring women comedians. At Le Noddi.',
      descFr:'Stand-up en anglais à Paris mettant en vedette des humoristes féminines. Au Noddi.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/english-stand-up-comedy-in-paris-funny-women-tickets-295960655287' },
    { name:'The Open Mic Express', venueName:'Le Kibélé', day:'Friday', time:'19:00', type:'openmic', emoji:'🚂',
      description:'English stand-up open mic in Paris. Drop in, sign up, perform.',
      descFr:'Scène ouverte de stand-up en anglais à Paris. Venez, inscrivez-vous, montez sur scène.',
      paid:false, bookingUrl:'https://www.eventbrite.com/e/the-open-mic-express-english-stand-up-comedy-april-17-tickets-1985629550437' },
    { name:'Oh My God She\'s Parisian! — Julie Coulon', venueName:'Théâtre BO Saint-Martin', day:['Friday','Saturday'], time:'20:15', type:'standup', emoji:'🎭', featured:true,
      description:'A French comedian with no filter — everything you\'ve ever wanted to know about Paris, told with razor-sharp Parisian irony. Professional theatre stage, full production. Friday & Saturday at 20:15.',
      descFr:'Une comédienne française sans filtre — tout ce que vous avez toujours voulu savoir sur Paris, raconté avec une ironie parisienne acérée. Scène de théâtre professionnel. Vendredi et samedi à 20h15.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/the-comedy-in-english-by-a-french-girl-that-will-make-you-love-paris-tickets-1764207685679' },
    { name:'Rocket Comedy Club', venueName:'Cotte 23', day:'Tuesday', time:'19:00', type:'standup', emoji:'🚀',
      description:'English and French stand-up comedy at Cotte 23 — Rocket Comedy Club runs every Tuesday at 19:00. A growing fixture on the Paris comedy scene.',
      descFr:'Stand-up en anglais et en français chez Cotte 23 — Rocket Comedy Club chaque mardi à 19h. Un rendez-vous croissant sur la scène parisienne.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/rocket-comedy-club-tickets-1001216875627' },
    { name:'Broadway Comedy Club Paris', venueName:'25 Bd de Bonne Nouvelle', day:'daily', time:'19:00', type:'standup', emoji:'🎬',
      description:'Paris\'s answer to the NYC institution — Broadway Comedy Club runs shows every evening at 25 Bd de Bonne Nouvelle. Multiple shows per week with rotating lineups.',
      descFr:'La réponse parisienne à l\'institution new-yorkaise — Broadway Comedy Club propose des spectacles chaque soir au 25 Bd de Bonne Nouvelle.',
      paid:true, bookingUrl:'https://www.eventbrite.com/e/billets-broadway-comedy-club-paris-1978410990530' },
    { name:'Kiss Comedy Club', venueName:'Le Coquin', day:'Wednesday', time:'20:00', type:'standup', emoji:'💋',
      description:'Kiss Comedy Club at Coquin — Wednesday nights at 20:00. English and French comedy in an intimate Paris venue.',
      descFr:'Kiss Comedy Club au Coquin — les mercredis à 20h. Comédie en anglais et en français dans un bar parisien intimiste.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/kiss-comedy-club-tickets-1935245083139' },
    { name:'South Comedy Club', venueName:'Comédie Café', day:'Wednesday', time:'20:00', type:'standup', emoji:'☀️',
      description:'South Comedy Club at Comédie Café — Wednesday nights and 40+ upcoming dates. One of the most active English comedy clubs in Paris.',
    ...
    { name:'FIAP Comedy Club', venueName:'FIAP Paris', day:'Thursday', time:'19:30', type:'standup', emoji:'🎭',
      ...
      paid:false },
    { name:'Oscar Comedy Club', venueName:'Café Oscar', day:'Sunday', time:'17:00', type:'standup', emoji:'🏆',
      description:'Oscar Comedy Club at Café Oscar — Sunday afternoons and 80+ upcoming dates. English and French comedy, one of the most frequent shows in Paris.',
      descFr:'Oscar Comedy Club au Café Oscar — dimanches après-midi et 80+ dates à venir. Comédie en anglais et en français, l\'un des programmes les plus fréquents de Paris.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/oscar-comedy-club-tickets-1985916648154' },
    { name:'Wednesday Night Comedy', venueName:'La Pomme d\'Eve', day:'Wednesday', time:'19:30', type:'standup', emoji:'🌙',
      ...
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/english-standup-wednesday-night-comedy-tickets-1750646975229' }
    ...
    { name:'Smash Comedy Club', venueName:'Comédie Café', day:'Saturday', time:'19:00', type:'standup', emoji:'💥',
      ...
      paid:false, bookingUrl:'https://www.eventbrite.com/e/smash-comedy-club-tickets-1902240916789' }
    { name:'IntégRire Comedy Night', venueName:'Le Kibélé', day:'Saturday', time:'19:00', type:'standup', emoji:'🌍',
      description:'IntégRire Comedy Night at Le Kibélé — Saturday evenings. Multicultural English comedy night with a diverse lineup.',
      descFr:'IntégRire Comedy Night au Kibélé — les samedis soir. Soirée comédie multiculturelle en anglais avec un plateau diversifié.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/integrire-comedy-night-3-tickets-1986334225138' },
    { name:'Kinto Comedy Club', venueName:'Poinçon Paris', day:'Friday', time:'19:30', type:'standup', emoji:'🎯',
      description:'Kinto Comedy Club at Poinçon Paris — Friday nights at 19:30. English stand-up in one of Paris\'s most atmospheric venues.',
      descFr:'Kinto Comedy Club au Poinçon Paris — les vendredis à 19h30. Stand-up en anglais dans l\'un des cadres les plus atmosphériques de Paris.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/kinto-comedy-club-au-poincon-tickets-1981428458859' },
    { name:'Greenwashing Comedy Club', venueName:'Césure', day:'Thursday', time:'20:00', type:'standup', emoji:'🌱',
      description:'Greenwashing Comedy Club at Césure and La Maison de la Conversation — Thursday evenings. English comedy with an eco-conscious twist.',
      descFr:'Greenwashing Comedy Club à Césure et La Maison de la Conversation — les jeudis. Comédie en anglais avec une touche engagée pour l\'environnement.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/greenwashing-comedy-club-a-cesure-tickets-1984380900692' + UTM },
    { name:'Charonne Comedy Club', venueName:'Le Café de la Plage', day:'Saturday', time:'19:30', type:'standup', emoji:'🏖️',
      description:'Charonne Comedy Club at Le Café de la Plage — Saturday evenings at 19:30 with 21+ upcoming dates. A consistent English comedy night in East Paris.',
      descFr:'Charonne Comedy Club au Café de la Plage — les samedis à 19h30 avec 21+ dates à venir. Soirée comédie en anglais régulière dans l\'est de Paris.',
      paid:false, bookingUrl:'https://www.eventbrite.fr/e/charonne-comedy-club-tickets-1697805324429' },
