...
const OTHER_SHOWS = [
    ...
    { name:'Green Mic Showcase', venueName:'Au Soleil de la Butte', day:'Friday', time:'20:15', type:'standup', emoji:'🎙️', description:'English stand-up showcase at Montmartre\'s Au Soleil de la Butte. Regular Friday slot — a growing fixture on the Paris English comedy scene.', paid:false },
    ...
    { name:'Kiss Comedy Club', venueName:'Le Coquin', day:'Wednesday', time:'20:00', type:'standup', emoji:'💋', description:'Kiss Comedy Club at Coquin — Wednesday nights at 20:00. English and French comedy in an intimate Paris venue.', paid:false, bookingUrl:'https://www.eventbrite.fr/e/kiss-comedy-club-tickets-1935245083139' },
    ...
    { name:'Wednesday Night Comedy', venueName:'La Pomme d\'Eve', day:'Wednesday', time:'19:30', type:'standup', emoji:'🌙', description:'English stand-up at La Pomme d\'Eve on Wednesday evenings at 19:30. Same venue as Blast Off All Stars — a reliable mid-week comedy night in the Latin Quarter.', paid:false },
    { name:'Cuba Compagnie Comedy Club', venueName:'Cuba Compagnie', day:'Tuesday', time:'19:30', type:'standup', emoji:'🎺', description:'Cuba Compagnie Comedy Club at 48 Bd Beaumarchais — Tuesday evenings at 19:30 with 25+ upcoming dates. One of the most established English comedy addresses in Paris.', paid:false },
    { name:'Mic Drop Comedy Club', venueName:'Speechless', day:'Wednesday', time:'20:00', type:'standup', emoji:'🎤', description:'Mic Drop Comedy Club at Speechless — Wednesday nights at 20:00. Regular English stand-up in Paris.', paid:false },
    { name:'LOFI Comedy Club', venueName:'Fada Paris', day:'Tuesday', time:'19:00', type:'standup', emoji:'🎵', description:'LOFI Comedy Club at Fada Paris — Tuesday evenings at 19:00. Laid-back English comedy night with a growing regular crowd.', paid:false },
    { name:'Smash Comedy Club', venueName:'Comédie Café', day:'Saturday', time:'19:00', type:'standup', emoji:'💥', description:'Smash Comedy Club at Comédie Café — 157+ upcoming dates across the week. One of the highest-volume English comedy programmes in Paris.', paid:false, bookingUrl:'https://www.eventbrite.fr/o/smash-comedy-club-paris' + UTM },
    ...
    { name:'Charonne Comedy Club', venueName:'Le Café de la Plage', day:'Saturday', time:'19:30', type:'standup', emoji:'🏖️', description:'Charonne Comedy Club at Le Café de la Plage — Saturday evenings at 19:30 with 21+ upcoming dates. A consistent English comedy night in East Paris.', paid:false },
    { name:'Sparkle Comedy Club', venueName:'Le TLM Paris', day:'Thursday', time:'21:00', type:'standup', emoji:'✨', description:'Sparkle Comedy Club at Le TLM Paris — Thursday nights at 21:00. Late-night English comedy in Paris.', paid:false }
];
