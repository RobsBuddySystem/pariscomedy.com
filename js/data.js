...
const OTHER_SHOWS_RAW = [
    ...
    { id:'charonne', name:'Charonne Comedy Club', venue:'cafe-plage', venueName:'Le Café de la Plage', address:'Paris', day:'Saturday', time:'19:30', type:'standup', emoji:'🏖️',
      ...
      bookingUrl:'https://www.billetreduc.com/spectacle/charonne-comedy-club-386471', paid:false,
      runner:'Charonne Comedy Club', verificationSource:'Eventbrite', verifiedAt:'2026-04-05', showUrl:'https://www.billetreduc.com/spectacle/charonne-comedy-club-386471',
...
const COMEDY_QUOTES = [
    ...
    { text:'"My brain now thinks in both French and English at the same time. The result is neither language — just a kind of anxious fog with a baguette in it."', author:'Robert le Ricain' },
