...
const PAGE_COPY = {
  ...
  fr: {
    ...
    venues: { subtitle:'15 salles de stand-up dans Paris — là où les rires se jouent chaque semaine', mapTitle:'🗺️ Carte des salles de stand-up', mapSub:'15 lieux de stand-up anglophone à Paris — cliquez sur un point pour voir les horaires', mapLegend:'🟣 = salle mise en avant avec rendez-vous hebdomadaires · 🔵 = autres lieux de stand-up anglophone', cardsTitle:'Salles de stand-up à Paris', cardsSub:'Retrouvez French Fried Comedy Night et 14 autres lieux anglophones à Paris', yourVenue:'🏠 <strong>Votre salle ici ?</strong>', yourVenueSub:'Si vous programmez du stand-up anglophone à Paris, on veut vous référencer.', yourVenueCta:'Être référencé →', actions:{ map:'Ouvrir la carte', walk:'À pied', transit:'Transports', drive:'Voiture', pending:'Le lien cartographique précis est encore en vérification.' }, map:{ tba:'Spectacles à venir' }, other:{ title:'Autres salles de stand-up à Paris', sub:'Ces lieux accueillent du stand-up en anglais. Vous voulez une fiche complète avec réservation ?', cta:'Être référencé', claim:'Spectacles pas encore référencés', claimCta:'revendiquer cette fiche' } },
